...
checkRunningApp RecordPreprocessing

flink run -c com.spdb.streaming.msgproc.RecordPreprocessing $ppp/lib/streaming-msgproc-1.1.jar --confPath $ppp/conf/RecordPreprocessing.yaml
