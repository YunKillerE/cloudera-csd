...
checkRunningApp FBXSceneAdapter

echo "Starting App FBXSceneAdapter"
flink run -c com.spdb.streaming.transaction.FlinkSaveTransaction $ppp/lib/streaming-transaction-1.1.jar --confPath $ppp/conf/FBXTransaction.yaml
